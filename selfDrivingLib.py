...
ReferenceTitles = ["Turn Left", "Turn Right", "Reverse", "Start", "Stop", "Magic"]
...
def four_point_transform(image, pts):
        ...
        # The first entry in the list is (0, 0)  indicating the top-left corner. The second entry is (maxWidth - 1, 0)  
        # which corresponds to the top-right corner. Then we have (maxWidth - 1, maxHeight - 1)  which is the bottom-right corner. 
