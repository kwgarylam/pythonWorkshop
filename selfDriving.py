# ======================================================= #
# Author: VTC STEM Centre
# Date: 27/7/2018
# Program Name: RoadSign Game version 1.2
# Description: Program code for integration (RoadSign Game)
# ====================================================== #
...
import numpy as np
import os
import selfDrivingLib as selfDrive
...
while True:
        ...
        # Detecting Edges
        edges = selfDrive.auto_canny(blurred)
        ...
        selfDrive.checkImage(OriginalFrame, contours, vertex, minSquareArea, minDiff)
